...
<body style="background-color:black">
 <center style="color:blue"><h3>Welcome to Conference Organiser!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Conference events</h4>
      ...
      <div class="modal-body">
           ...
           <%
ArrayList ConferenceEvent = (ArrayList)request.getAttribute("ConferenceEvent");
if (ConferenceEvent.size()!=0) {
%>
...
<%
Iterator<insertEvent> itr= ConferenceEvent.iterator();

while(itr.hasNext())
{
	
insertEvent us =itr.next();
%>

<option  value="<%= us.getEventid() %>"><%= us.getEventid() %></option>
<% 
}%></select>
        ...
        <input name="nooftickets" type="text" class="form-control" required>
...
<div   style="font-size:20px;background-color:purple">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="Images\Conference\conference1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item  active">
      <img src="Images\Conference\conference2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Conference\conference3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
