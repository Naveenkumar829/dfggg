...
<title>Exhibition and Trade Fair</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body>
<center style="color:blue"><h3>Welcome to Exhibition and Trade Fair!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Exhibition events</h4>
      ...
      <div class="modal-body">
         <%
ArrayList ExhibitionEvent = (ArrayList)request.getAttribute("ExhibitionEvent");
if (ExhibitionEvent.size()!=0) {
%>
...
<%
Iterator<insertEvent> itr= ExhibitionEvent.iterator();
...
<div  style="font-size:20px;background-color:rgb(255, 229, 81)">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images\Exhibition\exhibition1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Exhibition\exhibition2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Exhibition\exhibition3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
