...
<body>
<center style="color:blue"><h3>Welcome to Birthday  Party Organiser!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Birthday events</h4>
      ...
      <div class="modal-body">
        ...
        <%
ArrayList BirthdayEvent = (ArrayList)request.getAttribute("BirthdayEvent");
if (BirthdayEvent.size()!=0) {
	%>
	<form method="post" action="TicketGenServlet" onsubmit="return ticketvalidation()">
	...
	<%
	Iterator<insertEvent> itr= BirthdayEvent.iterator();
	...
	<% 
	        ...
	        <label class="form-group mt-2">No of Tickets</label><span id="span2"></span>
	        <input name="nooftickets" type="number" class="form-control" id="booktickets" required>
	        <button type="submit" class="btn btn-primary mt-2">Submit</button>
	        </form>
	<%
}
else{ %>
        <b>Current  No Events to  Book</b> <%} %>    </div>
...
<div   style="font-size:20px;background-color:pink">
<div style="font-size:20px">
<p style="color:black"><span style="color:red;margin-left:120px">*</span> Current Events<br/>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images\Birthday\birthday1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Birthday\birthday2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Birthday\birthday3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
...
function ticketvalidation(){
	var  tickets = document.getElementById("booktickets").value;
	console.log(tickets);
