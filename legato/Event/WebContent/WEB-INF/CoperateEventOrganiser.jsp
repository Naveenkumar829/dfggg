...
<title>Coperate Event Organiser</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body class="bg-light">
 <center style="color:blue"><h3>Welcome to Coperate Event Organiser!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Co-operate events</h4>
      ...
      <div class="modal-body">
                <%
ArrayList CoperateEvent = (ArrayList)request.getAttribute("CoperateEvent");
if (CoperateEvent.size()!=0) {
%>
<form action="TicketGenServlet" method="post">
        <label class="form-group">Event id</label><span style="color:red;font-size:15px"> *</span>
<select required name="eventid" class="form-control"><option selected="true" value="" disabled="disabled"> please select the event name</option>
<%
Iterator<insertEvent> itr= CoperateEvent.iterator();
...
<div   style="font-size:20px;background-color:lightgreen">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="Images\Coperate\coperate1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item  active">
      <img src="Images\Coperate\coperate2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Coperate\coperate3.png" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
