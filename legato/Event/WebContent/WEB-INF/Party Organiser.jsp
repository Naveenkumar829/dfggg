...
<title>Party Organiser</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body>
<center style="color:blue"><h3>Welcome to  Party Organiser!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Party events</h4>
      ...
      <div class="modal-body">
        ...
        <%
ArrayList partyevent = (ArrayList)request.getAttribute("partyevent");
if (partyevent.size()!=0) {
%>
...
<%
Iterator<insertEvent> itr= partyevent.iterator();
...
<div   style="font-size:20px;background-color:rgb(86, 190, 255)">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="Images\Party\party1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item  active">
      <img src="Images\Party\party2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Party\party3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
