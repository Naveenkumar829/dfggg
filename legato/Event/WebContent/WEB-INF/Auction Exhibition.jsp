...
<title>Auction Exhibition</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body style="background-color:darkturquoise">
<center style="color:blue"><h3>Welcome to Auction Exhibition!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Auction events</h4>
      ...
      <div class="modal-body">
                   <%
ArrayList AuctionEvent = (ArrayList)request.getAttribute("AuctionEvent");
if (AuctionEvent.size()!=0) {
%>
...
<%
Iterator<insertEvent> itr= AuctionEvent.iterator();
...
<div   style="font-size:20px;background-color:lavenderblush">
<div style="font-size:20px">
<p style="color:dimgray"><span style="color:red;margin-left:120px">*</span> Current Events<br/>
...
<a href="#"style="color:black">LADIES NIGHT
Panic on the Dance Floor - Poolside Ladies
Taj MG Road, Bengaluru
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="Images\Auction\auction1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Auction\auction2.gif" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item active">
      <img src="Images\Auction\auction3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
