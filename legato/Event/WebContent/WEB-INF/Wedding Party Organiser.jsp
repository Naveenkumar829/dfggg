...
<body>
<center style="color:blue"><h3>Welcome to Wedding Party Organiser!!!</h3></center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Booking for Wedding events</h4>
      ...
      <div class="modal-body">
        <%
ArrayList Weddingevent = (ArrayList)request.getAttribute("Weddingevent");
if (Weddingevent.size()!=0) {
%>
...
<%
Iterator<insertEvent> itr= Weddingevent.iterator();
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images\Wedding\wedding1.jpg"" alt="Los Angeles" style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Wedding\wedding2.jpg" alt="Hard Rock Cafe"style="width:800px;height:380px">
    </div>
    <div class="carousel-item">
      <img src="Images\Wedding\wedding3.jpg" alt="Strom festival"style="width:800px;height:380px">
    </div>
  </div>
 ...
 <b>Priyanka and Nick Jonas Wedding!!</b>
